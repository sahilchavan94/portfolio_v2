...
const About = () => {
    ...
    return (
        <motion.div ref={ref} id='about'
            ...
            className='w-full mt-10 lg:mt-16 flex flex-col items-start justify-center lg:w-[80%] h-fit min-[1300px]:h-[75vh] mx-auto'>
            <div className='text-white md:text-start text-start heading w-[90%] md:w-full text-4xl md:text-6xl font-bold tracking-tight mx-auto'>About Me</div>
            <div className='flex flex-col lg:flex-row  justify-center items-center text-text_light mt-10 gap-10 md:gap-16'>
                <div className="my-info font-normal text-sm md:text-base w-full pl-7 pr-6 md:pl-0 md:pr-0 md:w-[90%] md:text-start mx-auto lg:[60%]">

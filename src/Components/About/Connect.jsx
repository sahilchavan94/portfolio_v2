        ...
        <motion.div className="connect mt-40 mb-20 w-[65%] mx-auto text-start"
            ...
            <div className='mx-auto flex justify-center items-center mt-14 gap-5' >
               <Link target='_blank' to={"https://www.facebook.com/profile.php?id=61554470909104"}> <motion.img ref={ref}
                    ...
                    initial="hidden"
                    animate={mainControls}
                    transition={{ duration: 0.8, delay: 0.35 }} className='w-12 h-12' src={fb} alt="" /></Link>
                <Link target='_blank' to={"https://github.com/sahil-gpm"}><motion.img ref={ref}
                    ...
                    initial="hidden"
                    animate={mainControls}
                    transition={{ duration: 0.8, delay: 0.6 }} className='w-12 h-12' src={github} alt="" /></Link>
                <Link target='_blank' to={"https://www.instagram.com/infinite_void_30/"}><motion.img ref={ref}
                    ...
                    initial="hidden"
                    animate={mainControls}
                    transition={{ duration: 0.8, delay: 0.8 }} className='w-12 h-12' src={ig} alt="" /></Link>
            </div>
            <div className="finish mt-20 mb-10 text-base text-center text-white font-normal opacity-30">
